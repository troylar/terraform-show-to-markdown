...
class ReportGenerator:
    def __init__(self, **kwargs):
        ...
        self.tokens = {}
        self.data = {}
        self.report_folder = kwargs.get('ReportFolder', 'report')
...
#                            self.create_icon(val)
    ...
    def create_icon(self, id):
        font = ImageFont.truetype('OpenSans-Bold.ttf', 10)
        w, h = font.getsize(id)
        ...
        msg = id
        draw.text(((width-w)/2, (height-h)/2), msg, font=font)
        img.save('{}/{}.png'.format(self.report_folder, id), "PNG")
